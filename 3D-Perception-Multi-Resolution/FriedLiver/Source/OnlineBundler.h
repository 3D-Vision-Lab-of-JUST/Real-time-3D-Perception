...
public:
	...
	void processInput(bool isUsePose_GT);
...
private:
	...
	void computeCurrentSiftTransform(bool bIsValid, unsigned int frameIdx, unsigned int localFrameIdx, unsigned int lastValidCompleteTransform, bool isUsePose_GT);
